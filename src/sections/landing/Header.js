  ...
  return (
    <Box
      sx={{
        position: 'relative',
        overflow: 'hidden',
        background: 'linear-gradient(180deg, rgba(240, 232, 245,0.5) 0%, rgba(233, 221, 240,0.5) 60%)'
      }}
    >
      {/* ===== Background Blobs ===== */}
      {/* <Bubble size={420} top="20%" right="-120px" delay={2} />
          ...
          >
            <Box ref={leftRef} sx={{ maxWidth: 560 }}>
              ...
              >
                ...
                >
                  <svg width="200" height="24" viewBox="0 0 200 24" style={{ overflow: 'visible' }}>
                    <motion.path
                      d="
                    M6 30
                    C 50 9, 150 10, 130 30
                ...
                >
                  Your personalized dashboard for accessing course materials, schedules, assignments, progress tracking, and academic tools.
                </Typography>
              </motion.div>
            </Box>
          </Grid>
