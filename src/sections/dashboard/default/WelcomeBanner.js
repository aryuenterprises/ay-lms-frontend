    ...
    >
      <Grid container >
        <Grid item md={8} sm={8} xs={12}>
          <Stack spacing={2} sx={{ p: 3, position: 'relative', zIndex: 2 }}>
            <Typography variant="h2" color={theme.palette.background.paper}>
              Welcome to the Aryu Academy{' '}
              {loginType === 'student'
                ? 'Student'
                : loginType === 'tutor'
                  ? 'Tutor'
            ...
            <Typography variant="h6" color={theme.palette.background.paper}>
              your's personalized space for accessing course materials, class schedules,
              assignments, progress tracking, and academic tools.
            </Typography>
        ...
        >
          <Stack sx={{ pl: 2, zIndex: 2 }} alignItems="flex-start">
