      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} display={'flex'} justifyContent={'space-between'}>
          <Stack direction="row" alignItems="center" justifyContent="center" spacing={1}>
            <Typography variant="subtitle1">Present Days : </Typography>
            <Typography color="success.dark" sx={{ display: 'flex', alignItems: 'center', gap: 0.5, fontWeight: 500 }}>
              {addData?.present}
            </Typography>
          </Stack>
          <Stack direction="row" alignItems="center" justifyContent="center" spacing={1}>
            <Typography variant="subtitle1">Absent Days : </Typography>
...
Attendance.propTypes = {
  attendance: PropTypes.shape({ present: PropTypes.number, absent: PropTypes.number, total: PropTypes.number, today: PropTypes.number })
    .isRequired,
