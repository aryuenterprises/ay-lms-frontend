...
// export const APP_PATH_BASE_URL = 'http://127.0.0.1:8002/';
...
const config = {
  ...
  /**
   * the props used for date format.
   * set date format dynamic
   * default - dd/mm/yyyy
   * false - will show date without format
   */
  dateFormat: 'dd/MM/yyyy',

  /**
   * the props used for date format.
   * set time format dynamic
   * default - HH:mm:ss
   * false - will show time without format
   */
  timeFormat: 'hh:mm a'
};
