...
const baseMenuItems = {
  ...
  children: [
    ...
    },
    {
      ...
      title: <FormattedMessage id="organization-list" defaultMessage="Organizations" />,
      type: 'item',
      url: '/organizations',
      icon: icons.chipMenu,
      show: (loginType === 'admin' || loginType === 'super_admin') && hasReadPermission('Organizations')
    },
    {
      id: 'admin-list',
    ...
    {
      id: 'organization-employer',
      title: <FormattedMessage id="organization-employer" defaultMessage="Organization Employer" />,
      type: 'item',
      url: '/organization-employer',
      icon: icons.userIcon,
      show: (loginType === 'admin' || loginType === 'super_admin') && hasReadPermission('Organization Employer')
    },
    {
      id: 'batch-list',
