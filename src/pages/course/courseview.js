...
const CourseView = () => {
  ...
  return (
    <MainCard sx={{ border: '1px solid #e9ddf0', boxShadow: '0 15px 40px #e9ddf0' }}>
      <Grid container justifyContent="space-between" alignItems="center" my={3} spacing={2}>
        <Grid item xs={12}>
          <Stack direction={{ xs: 'column', sm: 'row' }} alignItems={{ xs: 'stretch', sm: 'center' }} spacing={2} width="100%">
            <Grid item display="flex" flexDirection={{ xs: 'column', sm: 'row' }}>
          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                {(userType === 'admin' || userType === 'super_admin') && <TableCell>Status</TableCell>}
            ...
            <TableBody>
              {filteredCourses &&
                ...
                filteredCourses.map((course, index) => (
                  <TableRow key={course.course_id} hover onClick={() => handleCardClick(course.course_id, course)}>
                    {/* S.No */}
                    ...
                    <TableCell>
                      <img
                        src={course.course_pic_url || defaultImage}
                        alt={course.course_name}
                        style={{
                          width: '50px',
                          height: '50px',
                    ...
                    {/* Status */}
                    {(userType === 'admin' || userType === 'super_admin') && <TableCell>{course.status}</TableCell>}
                    ...
                    <TableCell align="right">
                      <Stack direction="row" spacing={1} justifyContent="flex-end">
                        <IconButton
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            handleCardClick(course.course_id, course);
                          }}
                        >
                          <Eye fontSize="small" />
                        </IconButton>
