...
const AttendanceTab = ({ attendance, course, batch, student_id, user_type }) => {
  ...
  // console.log(selectedCourse,"come at first")
  ...
  // useEffect(() => {
  //   console.log('Courses prop:', course);
  // }, [course]); 
  useEffect(() => {
    if (attendance) {
      setAttendanceData(
    ...
    // console.log(filterCourse,filterBatch,"bother are here first is filtercourse")
  ...
  const filteredBatches=selectedCourse ? batches.filter(
    (b)=>String(b.course_id)===String(selectedCourse))
  : batches;


// console.log(filterCourse,courses,course,"filterCourse")
  ...
  const filteredItems = attendanceData.filter((item) => {
    ...
    if (filterCourse) {
      ...
      // console.log(filterCourse,"filter is working ")

      
      if (item.course_id !== filterCourse.course_id) {
        // console.log(selectedBatch,"print")
        return false;
      }
    }
    ...
    if (filterBatch) {
      ...
      // console.log(filterBatch,"filterBatch",filterCourse)
      ...
      >
        ...
        <Autocomplete
          ...
          onChange={(event,newValue) => {
            ...
            //  console.log(newValue,"working ",filterCourse)
          }}
          size="small"
          sx={{
            width: { xs: '100%', sm: 180 },
          ...
          filterOptions={(options = [], state) => {
            // {console.log(options,"options is working ")}
      ...
      {(userType === 'admin' || userType === 'super_admin') && (
        <Grid container sx={{ minHeight: { xs: '50vh', md: '50vh', lg: '40vh' } }}>
            ...
            <Grid item xs={12} md={8}>
              <Select
                ...
                onChange={(e) => {
                  ...
                  // console.log(e.target.value,"values is update here ")
                  setSelectedCourse(e.target.value);
                  

                  //  console.log(selectedCourse,"batch course is selected")
              ...
              >
                ...
                {courses.length > 0 ? (
                  courses.map((c) => (
                    <MenuItem key={c.course_id} value={String(c.course_id)}>
                      {c.course_name}
                    </MenuItem>
                  ))
                ) : (
          ...
          <Grid container item xs={12} alignItems="center">
            ...
            <Grid item xs={12} md={8}>
            {/* {console.log(selectedBatch,"it has apperar")} */}
              <Select
                value={selectedBatch}
