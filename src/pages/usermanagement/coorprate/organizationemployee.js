      ...
      if (result.isConfirmed) {
        try {
          ...
          if (response.data.success) {
            await Swal.fire({
              title: 'Success!',
              text: 'Organization employer deleted successfully!',
              icon: 'success',
          ...
          Swal.fire({
            title: 'Error!',
            text: error.response?.data?.message || 'Failed to delete organization employer.',
            icon: 'error',
            confirmButtonText: 'OK'
          });
        } finally {
    ...
    onSubmit: async (values, { resetForm, setSubmitting }) => {
      ...
      try {
        ...
        if (response.data.success === true) {
          Swal.fire({
            title: 'Success!',
            text: currentStudent ? 'organization employer updated successfully!' : 'organization employer added successfully!',
            icon: 'success',
            confirmButtonText: 'OK'
          });
          resetForm();
          ...
          Swal.fire({
            title: 'Error!',
            text: response?.data?.message || 'Error submitting organization employer data. Please try again.',
            icon: 'error',
            confirmButtonText: 'OK'
          });
        }
        ...
        Swal.fire({
          title: 'Error!',
          text: 'Error submitting organization employer data. Please try again.',
          icon: 'error',
          confirmButtonText: 'OK'
        });
      } finally {
