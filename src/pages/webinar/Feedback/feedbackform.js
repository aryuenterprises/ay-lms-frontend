...
const WebinarFeedbackForm = () => {
  ...
  if (data?.message?.includes("duplicate key")) {
    ...
    message = "Unregistered number entered. Please enter a registered number.";
  }
...
<Box sx={{flex:1}}>
  ...
  <Typography variant="body2" sx={{ mb: 2, color: 'text.secondary' }}>
    If you enjoyed the webinar, please leave a Google review about Aryu Academy.
    After submitting your review, upload a screenshot below.
  </Typography>
