...
import feedbackQr from "../../../assets/images/landing/feedbackQr.jpg";
...
const WebinarFeedbackForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.learned_something_new === null)
      errors.learned_something_new = "Please select Yes or No";
    if (form.would_recommend === null)
      errors.would_recommend = "Please select Yes or No";
    if (form.interested_in_future_webinars === null)
      errors.interested_in_future_webinars = "Please select Yes or No";
    if (form.interested_in_paid_courses === null)
      errors.interested_in_paid_courses = "Please select Yes or No";
    ...
    payload.append(
      "interested_in_future_webinars",
      String(form.interested_in_future_webinars),
    );
    payload.append(
      "interested_in_paid_courses",
      String(form.interested_in_paid_courses),
    );
    ...
    try {
      const res = await axiosInstance.post(`/api/webinar/feedback/`, payload, {
      ...
      //   let message = "Registered phone number is required.";

      //   if (data.phone) {
      //     message = data.phone.join(", ");
      //   }
      ...
      if (res?.data?.success === false) {
        ...
        if (data?.message?.includes("duplicate key")) {
          ...
          message =
            "Unregistered number entered. Please enter a registered number.";
        } else if (data?.message) {
          message = data.message;
        }
      ...
      let message = "Feedback is already submitted";
      ...
      <Box
        ...
        <Box
          ...
          <motion.div
            ...
            <Typography
              variant="h4"
              sx={{ fontWeight: 700, color: "#7f1d1d", mb: 5 }}>
              Webinar Feedback
            </Typography>
              ...
              {[
                ...
                <Grid item xs={12} md={6} key={key}>
                  <Box
                    ...
                    <Rating
                      value={form[key]}
                      onChange={(e, value) => handleChange(key, value || 0)}
                    />
                    {fieldErrors[key] && (
            ...
            <TextField
              ...
              onChange={(e) =>
                handleChange("additional_comments", e.target.value)
              }
            />
            <Box
              sx={{
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <Typography
                  ...
                  If you enjoyed the webinar, please leave a Google review about
                  Aryu Academy. After submitting your review, upload a
                  screenshot below.
                </Typography>
              </Box>
              <Box
                ...
                <Box>
                  <Button
                    variant="outlined"
                    href="https://g.page/r/CVqEyl8vUTSDEAE/review"
                    target="_blank"
                    sx={{
                      mb: 3,
                      borderColor: "#9f1239",
                  ...
                  <Button
                    ...
                    <input
                      ...
                      hidden
                      accept="image/*"
                      onChange={(e) => setRatingScreenshot(e.target.files[0])}
                    />
                  </Button>
        ...
        <Dialog
          ...
          <DialogContent>
            <Typography
              ...
              {/* {errorMsg || "Only registered students can fill this feedback form."} */}
        ...
        <Dialog
          ...
          <DialogContent>
            ...
            <Typography
              ...
              Your participation certificate has been successfully issued and
              sent to your registered email address.
              <br />
              Please check your <strong>Email</strong> and{" "}
              <strong>WhatsApp</strong> for the certificate.
              <br />
              <br />
              If you do not receive it within a few minutes, kindly check your
