...
const sendReply = async (ticketId, message) => {
  const res = await fetch(
    `${APP_PATH_BASE_URL}/api/webinar/tickets/${ticketId}/reply/`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    <Box
      ...
      <Box
        ...
        <Box
          ...
          <Typography
            variant="overline"
            sx={{ fontWeight: 900, color: "#b71c1c" }}>
            ARYU ACADEMY
          </Typography>
          ...
          <Typography sx={{ mt: 3, maxWidth: 480, color: "#555" }}>
            Need assistance regarding your webinar? Connect with our support
            team and get quick resolutions within 24 hours.
          </Typography>
              ...
              {step === "chat" && ticket && (
                <motion.div
                  ...
                  <Stack direction="row" justifyContent="space-between">
                    ...
                    <Chip
                      label={ticket.status}
                      sx={{ bgcolor: "#fdecea", color: "#b71c1c" }}
                    />
                  </Stack>
